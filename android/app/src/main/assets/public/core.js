...
export function fixtureError(error,{online=true}={}){
  ...
  if(code==='API_ORIGIN_NOT_CONFIGURED')return {title:'Scores backend is not configured',message:'Set the deployed Cloudflare Worker URL in config.js and rebuild the app.'};
