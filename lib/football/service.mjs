...
export class FootballService {
  ...
  async fixtureStandings(id){const fixture=(await this.fixture(id)).data;if(!fixture)return envelope(null,{provider:this.provider.name,unavailable:true});if(!fixture.competition.id||!fixture.competition.season)return envelope([],{provider:this.provider.name,unavailable:true});return this.standings(fixture.competition.id,fixture.competition.season)}
